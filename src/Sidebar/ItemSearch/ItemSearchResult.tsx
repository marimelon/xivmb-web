...
export const ItemSearchResult: React.FC<Props> = ({ value, onClick, activeItem, favoriteList, addFavoriteCB }) => {
        ...
        return (
            <SidebarItem
                ...
                <FavoriteButton
                    ...
                    addFavoriteCB={() => { addFavoriteCB(itemid, window.ItemList.get(itemid) ?? "???"); }} />
            </SidebarItem>
        );
    };
    return (
