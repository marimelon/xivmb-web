...
const SortableItem = SortableElement(
  ({ value, onClickItem, activeItem, children }: SortableItemProps) => {
...
export const FavoriteItemList = SortableContainer(
  ({ items, onClickItem, activeItem, deleteFavoriteCB }: Props) => {
    return (
      <div>
